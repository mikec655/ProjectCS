...
class Project:
    ...
    def test(self,i,sensor):

        app.grafiek(i,sensor)
        ani = animation.FuncAnimation(self.fig, self.grafiek, interval=5000)


    def grafiek(self,i, sensor):
        self.sensor = sensor
        fig = Figure()
